    ...
    <div className="min-h-screen w-full overflow-hidden relative">
      ...
      <section className="min-h-screen flex flex-col items-center justify-center px-4 md:px-8 relative">
        ...
        >
          {/* Casper Wordmark */}
          <motion.div 
            className="text-4xl md:text-5xl font-bold tracking-[0.3em] text-primary uppercase mb-6"
          ...
          {/* Subheadline */}
          <motion.p 
            className="text-base md:text-lg text-muted-foreground mt-2 text-center"
            variants={fadeUpVariants}
            custom={2}
          >
